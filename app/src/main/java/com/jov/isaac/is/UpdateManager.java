...
import com.jov.isaac.is.util.FileUtil;
import com.jov.isaac.is.util.UpdateBean;
import com.jov.isaac.is.util.XMLReader;
...
public class UpdateManager {
	...
	private final Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case DOWN_OK:
				...
				notification.tickerText = "以撒图鉴下载完成，点击安装";
				notification.setLatestEventInfo(context, "以撒图鉴", "下载完成，点击安装",
						pendingIntent);
				notificationManager.notify(notification_id, notification);
				context.startActivity(intent);
				break;
			case DOWN_ERROR:
				notification.setLatestEventInfo(context, "以撒图鉴", "下载失败",
						pendingIntent);
				break;
			case NEW_UPDATE:
				if (bean == null) {
	...
	private void createNotification() {
		...
		notification.tickerText = "以撒图鉴更新";
